...
const Quiz = ({ shuffleQuestions = false }) => {
  ...
  const { text, setText, avatarCanvasRef, animateAndSpeak, SpeechComponent } = useTalkingAvatar("/img/talking-girl.png");
  ...
  useEffect(() => {
    ...
    setText(currentStatement.statement);
      ...
      <div className="min-h-screen bg-white shadow-lg max-w-lg w-full text-center pb-8">
        ...
        <div className="flex flex-col items-center py-2 bg-gray-50 border-b">
          ...
          {currentStatement.image && (
            ...
            <canvas
              ref={avatarCanvasRef}
              className="max-w-72 h-72 border rounded"
              width="500"
              height="500"
            />
          )}
          <div className="flex items-center text-blue-700">
            <div id="play-statement" onClick={()=>{setStatementPlayed(true);animateAndSpeak()}} className="cursor-pointer p-1 rounded-full">
              <Speech
                text={text}
                lang="es-US"
                rate={0.8}
