...
export const story1Statements = [
  ...
  },
  {
    ...
    statement: "El doctor dice: '¿Qué es tu problema?'",
...
export const story1Questions = [
  ...
  //El doctor dice: '¿Qué es tu problema?'-------------
  {
    ...
    question:  "¿Dice el doctor: '¿Qué es tu problema?'",
    qtranslation: "Does the doctor say, 'whats your problem'?",
    image: "https://picsum.photos/444",
    answer: "sí",
    feedback: "El doctor dice: '¿Qué es tu problema?'",
    explanation: "",
    point: 20,
  },
  {
    ...
    statementId: "f1a9f37d-e919-4046-a754-f5d17d8679cd",
    question:  "¿Dice el doctor: '¿Qué es tu solución?'",
    qtranslation: "Does the doctor say, 'whats your solution'?",
    image: "https://picsum.photos/443",
    answer: "no",
    feedback: "El doctor no dice: '¿Qué es tu solución?'. El doctor dice: '¿Qué es tu problema?'",
    explanation: "",
    point: 20,
  },
  {
    ...
    statementId: "f1a9f37d-e919-4046-a754-f5d17d8679cd",
    question:  "¿Dice el doctor: '¿Qué es tu solución?' o '¿Qué es tu problema?'",
    qtranslation: "Does the doctor say, 'whats your solution' or 'whats your problem'?",
    image: "https://picsum.photos/442",
    answer: "qué es tu problema",
    feedback: "El doctor dice: '¿Qué es tu problema?'",
    explanation: "",
    point: 20,
  },
  {
    ...
    statementId: "f1a9f37d-e919-4046-a754-f5d17d8679cd",
    question:  "¿Dice Enrique: '¿Qué es tu problema?'",
    qtranslation: "Does Enrique say, 'whats your solution'?",
    image: "https://picsum.photos/441",
    answer: "no",
    feedback: "Enrique no dice: '¿Qué es tu problema?'. El doctor dice: '¿Qué es tu problema?'",
    explanation: "",
    point: 20,
  },
  {
    ...
    statementId: "f1a9f37d-e919-4046-a754-f5d17d8679cd",
    question:  "¿Dice el jinete: '¿Qué es tu problema?'",
    qtranslation: "Does the horseman say, 'whats your problema'?",
    image: "https://picsum.photos/440",
    answer: "no",
    feedback: "El jinete no dice: '¿Qué es tu problema?'. El doctor dice: '¿Qué es tu problema?'",
    explanation: "",
    point: 20,
  },
  {
    ...
    statementId: "f1a9f37d-e919-4046-a754-f5d17d8679cd",
    question:  "¿Quén dice: '¿Qué es tu problema?'",
    qtranslation: "Who says, 'whats your problem'?",
  ...
  //El jinete sin cabeza dice: 'Tengo un dolor de cabeza.'-------------
  {
    ...
    question:  "¿Dice el jinete sin cabeza: 'Tengo un dolor de cabeza.'?",
    qtranslation: "Does the horseman without head say, 'I have a headache'?",
    image: "https://picsum.photos/438",
    answer: "sí",
    feedback: "El doctor dice: '¿Qué es tu problema?'",
    explanation: "Dolor = pain, de = of",
    point: 20,
  },
  {
    id: "ab448d81-34ff-4f19-820b-0d77ffd17e02",
    statementId: "6fe0021a-07cf-4439-ab45-9bbb56748068",
    question:  "¿Dice Enrique: 'Tengo un dolor de cabeza.'?",
    qtranslation: "Does Enrique say, 'I have a headache'?",
    image: "https://picsum.photos/437",
    answer: "no",
    feedback:  "El Enrique no dice: 'Tengo un dolor de cabeza.'. El jinete dice: 'Tengo un dolor de cabeza.'",
    explanation: "",
    point: 20,
  },
  {
    ...
    statementId: "6fe0021a-07cf-4439-ab45-9bbb56748068",
    question:  "¿Dice Enrique o el jinete sin cabeza: 'Tengo un dolor de cabeza.'?",
    qtranslation: "Does Enrique say, 'I have a headache'?",
  ...
  },
  {
    id: "940f75a4-cd65-4997-bd26-5d848ba33bce",
    statementId: "6fe0021a-07cf-4439-ab45-9bbb56748068",
    question: "¿Enrique tiene un dolor de cabeza?",
    qtranslation: "Does Enrique have a headache?",
    image: "https://picsum.photos/435",
    answer: "no",
    feedback: "Enrique no tiene un dolor de cabeza. El jinete tiene un dolor de cabeza.",
    explanation: "Dolor = pain, de = of",
    point: 20,
  },
  {
  ...
  },
  {
    id: "d4ce8761-1fff-4261-b196-a818544aa426",
    statementId: "6fe0021a-07cf-4439-ab45-9bbb56748068",
    question: "¿Quién tiene un dolor de cabeza?",
    qtranslation: "Who has a headache?",
    image: "https://picsum.photos/433",
    answer: "jinete",
    feedback: "El jinete sin cabeza tiene un dolor de cabeza.",
    explanation: "Dolor = pain, de = of",
    point: 20,
  },
]
...
export const storydata2 = {
  ...
  statements: [
    ...
    {
      image: "https://picsum.photos/498",
      statement: 'El médico pregunta, "¿Qué es tu problema?"',
      questions: [
        {
          question: '¿El médico pregunta, "¿Qué es tu problema?"?',
          qtranslation: 'Shifokor, "Sizning muammoingiz nima?" deb soraydimi?',
          answer: "sí",
          feedback: 'El médico pregunta, "¿Qué es tu problema?"',
          explanation: "La pregunta es si el médico pregunta sobre el problema del paciente, y la respuesta lo confirma.",
          point: 20,
        },
        {
          question:
            '¿El médico pregunta, "¿Qué es tu problema?" o "¿Cómo estás?"',
          qtranslation:
            'Shifokor, "Sizning muammoingiz nima?" yoki "Qalaysiz?" deb soraydimi?',
        ...
        },
        {
          ...
          answer: "no",
          feedback:
            'El médico no pregunta, "¿Cómo estás?". El médico pregunta, "¿Qué es tu problema?".',
