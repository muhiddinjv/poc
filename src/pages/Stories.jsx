            ...
            <div key={index} className="bg-white rounded-lg shadow-lg mb-4 p-2 flex items-center space-x-3">
              ...
              <div className='flex flex-col justify-around items-between min-h-24'>
                ...
                <div className="flex flex-wrap space-x-2">
                  <Link to={`/words/${story.id}`} className="bg-blue-500 text-white px-3 py-1 rounded-lg shadow-sm hover:bg-blue-600">O'rgan</Link>
                  <Link to={`/games/${story.id}`} className="bg-green-500 text-white px-3 py-1 rounded-lg shadow-sm hover:bg-green-600">Gapir</Link>
                  <Link to={`/story/${story.id}`} className="bg-pink-500 text-white px-3 py-1 rounded-lg shadow-sm hover:bg-pink-600">O'qish</Link>
                </div>
              </div>
            </div>
          ))}
