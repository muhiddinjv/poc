...
export const questions = [
  ...
  },
  {
    ...
    question:{
      ...
      en: "am I the horseman without head?",
    },
  ...
  // El jinete tiene un problema------------------------------------
  {
    ...
    explanation:{
      en: "'Él tiene' means 'he he has' in English so you can simply say 'tiene' ",
    },
    point: 20,
  },
  {
  ...
  // Va al doctor ------------------------------------------
  {
    ...
    explanation:{
      en: "'Él va' literally means 'he he goes' in English so you can leave out the 'Él' if you want",
    },
    point: 20,
  },
  {
